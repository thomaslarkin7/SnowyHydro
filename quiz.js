...
var all_questions = [{
    ...
    choices: {
      correct: "Noticeable contribution towards aviation in Australia",
      wrong: ["Consistent hard work on the Snowy Hydro", "Noticeable contribution towards Engineering in Australia", "30 years of service to the Snowy Hydro Scheme"]
    }
  }, {
    ...
    choices: {
      ...
      wrong: ["Water consumption on camp calculations", "Rainfall measurements and road safety", "Construction of dams"]
    }
  },
  {
    question_string: 'What unfortunate incident occurred to Kazys Sinkevisius during his time at Snowy Hydro?',
    choices: {
  ...
  {
    question_string: 'Which Electrical Engineer moved to Australia after seeing a Snowy Hydro advertisement  in the local paper?',
    choices: {
      correct: "Harold Gibbs",
      wrong: ["Ildiko Botka", "Gerard Willem van Wezel", "Joseph Gotts"]
    }
  },
  {
    question_string: 'Which character was most interested in soil testing?',
    choices: {
      correct: "Robert Brodie",
      wrong: ["Josef Peska", "Heinz Jeromin", "Paul Meredith"]
    }
  },
  {
    question_string: 'Being deaf was said to be “no handicap” to someone in what job?',
    choices: {
      correct: "Tracer",
      wrong: ["Timekeeper", "Pilot", "Electrical Engineer"]
    }
  },
  {
    question_string: 'At the same time as being offered a job on the Snowy Hydro, what happened to Rudolf Belin in New Zealand?',
    choices: {
      correct: "He was offered a promotion at his current workplace",
      wrong: ["He won the lottery", "He married his childhood sweetheart", "He decided to specialise in electrical engineering "]
    }
  },
  {
    question_string: 'In his school report, Peter French was described as having what by his principal?',
    choices: {
      correct: "'a bay of potential'",
      wrong: ["'a bay of bad habits'", "'a great attitude to learning'", "'a very noisy pet dog'"]
    }
  },
  {
    question_string: 'Who did the Snowy Hydro Authority decide to “never again employ” after they did not return from a work trip to Sweden?',
    choices: {
      correct: "Thomas Crawford",
      wrong: ["Peter French","Thomas Holiday","Douglas Leckie"]
    }
  },
  {
    question_string: 'Which four languages did Joseph Gotts have a knowledge of?',
    choices: {
      correct: "English, German, Dutch and French",
      wrong: ["English, German, Danish and Italian", "English, Greek, Dominican and Filipino", "English, German and Pig Latin"]
    }
  },
  {
    question_string: 'What was the main use for scaled models of the Snowy Hydro Scheme?',
    choices: {
      correct: "To use for display purposes around Australia",
      wrong: ["To use as artwork", "For the workers to play with in their free time", "To use for future work planning"]
    }
  }
    ...
    $('#submit-button').click(function() {
     ...
     $('#quiz-retry-button').click(function(reset) {
      ...
      if (percentage === 1) {
        ...
        message = 'Not bad, a passing score.'
      } else {
        message = 'Maybe you should try again.'
      }
